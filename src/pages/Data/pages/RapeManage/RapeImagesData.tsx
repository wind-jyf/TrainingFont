...
let DataPath = {
  pathname: 'adminRape/addRapeData',
  query: { key: '', itemObject: {} },
}
let ImagePath = {
  pathname: 'adminRape/addRapeImages',
  query: { key: '', itemObject: {} },
}
let ChangeImagePath = {
  pathname: 'adminRape/changeRapeImages',
  query: { key: '', itemObject: {} },
}
let ChangeDataPath = {
  pathname: 'adminRape/changeRapeData',
  query: { key: '', itemObject: {} },
}
...
export const RapeImagesData = (year: string) => {
