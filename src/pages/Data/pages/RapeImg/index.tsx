...
import { getAccessionIdRapeList, getRapeImgList } from '../../../../api/rape';
...
export const RapeImg = () => {
    ...
    const handleGetAccessionId = (year: any) => {
        return getAccessionIdRapeList({year}).then((result) => {
    ...
    return (
        <div className={$style['rapeWrapper']}>
            <SearchPanel 
