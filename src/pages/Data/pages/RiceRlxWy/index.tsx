...
export const RiceRlxWy = () => {
    ...
    const handleGetAccessionId = (data?: any, conditionCase=false) => {
            ...
            default:
                return (
                    ...
                    <Form.Item name="condition" label='Condition:' rules={[{ required: true, message: 'Condition is required'}]} initialValue={query.condition && query.condition[0].value}>
                        <Select style={{width: 200}} showSearch placeholder='Pick Condition' onChange={() => handleGetAccessionId(form.getFieldsValue(), true)}>
